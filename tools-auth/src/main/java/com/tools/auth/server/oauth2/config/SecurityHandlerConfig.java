	...
	public AuthenticationSuccessHandler loginSuccessHandler() {
		return new SavedRequestAwareAuthenticationSuccessHandler() {
			...
			public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
				...
				System.out.println("登陆成功=============request:"+request);
				System.out.println("登陆成功=============response:"+response);
				System.out.println("登陆成功=============authentication:"+authentication);
	...
	* @date: 		2019年5月7日
	...
	public WebResponseExceptionTranslator webResponseExceptionTranslator() {
		return new DefaultWebResponseExceptionTranslator() {
			...
			public static final String BAD_MSG = "Bad credentials";//错误凭证
			...
			public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
				...
				if (e.getMessage() != null && e.getMessage().equals(BAD_MSG)) {
					...
					oAuth2Exception = new InvalidGrantException(e.getMessage(), e);
				}/* else if (e.getMessage().equals("Missing grant type")) {
					oAuth2Exception = new UnsupportedResponseTypeException("请求参数中无grant_type信息");
				}*/
				else {
